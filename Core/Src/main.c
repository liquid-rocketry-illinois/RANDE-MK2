...
static void MX_GPIO_Init(void) {
    ...
    /*Configure GPIO pins : SCH7_Pin SCH3_Pin SCH6_Pin SCH5_Pin
                             SCH4_Pin LED2_Pin */
    GPIO_InitStruct.Pin = SCH7_Pin | SCH3_Pin | SCH6_Pin | SCH5_Pin | SCH4_Pin | LED2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CELL2_DIN_GPIO_Port, &GPIO_InitStruct);

    /* EXTI interrupt init*/
    HAL_NVIC_SetPriority(CELL2_DIN_EXTI_IRQn, 0, 0);
    HAL_NVIC_EnableIRQ(CELL2_DIN_EXTI_IRQn);
